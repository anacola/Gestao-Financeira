package br.com.gestaofinanceira.gestao.controller;
...
import br.com.gestaofinanceira.gestao.Dao.UsuarioDAO;
...
public class UsuarioController {
	...
	public ResponseEntity<Usuario> login(@RequestBody Usuario incompleto) {
		...
		Usuario resultado = dao.findByApelidoOrEmail(incompleto.getApelido(), incompleto.getEmail());
